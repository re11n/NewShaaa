 ...
 * @author Lenovo
 */
public class LihatAllForm extends javax.swing.JFrame {

    /**
     * Creates new form LihatAllForm
     */
    public LihatAllForm() {
        initComponents();
        try {
            ...
            String sql = "select NoBus, asal, tujuan, tanggal, case when Tanggal > CURRENT_DATE() then 'Belum Berangkat' else 'Sudah Berangkat' end as `Status` from busdatabase";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Semua Jadwal Bus");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LihatAllForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LihatAllForm().setVisible(true);
            }
        });
    }
